    ...
    def train(self):
        while True:
            while not self.received:
                try:
                    send_address = ('166.111.81.72', 13237)
            ...
            if self.received:
                ...
                if net_str in self.accuracy_trace:
                    ...
                    print("--"*15)
                    self.acc = train_client.run(genotype_net, epochs=600, batch_size=96*4, lr=0.025*2)
            ...
            while self.received:
                try:
                    recv_address = ('166.111.81.72', 13237)
